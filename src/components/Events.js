        ...
        return (
            <div className="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                <div className="card-body d-flex align-items-center p-4">
                    <h4 className="fw-700 mb-0 font-xssss text-white">Eventos</h4>
                    <a href="/defaultevent" className="fw-600 ms-auto font-xssss text-white">Ver más</a>
                </div>
                ...
                <div  key={index} className="card-body d-flex pt-0 ps-4 pe-4 pb-3 overflow-hidden">
                    ...
                    <h4 className="fw-700 text-white font-xssss mt-2">{value.name} <span className="d-block font-xsssss fw-500 mt-1 lh-4 text-white">{value.location}</span> </h4>
                </div>
