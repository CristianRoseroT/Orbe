        ...
        return (
            <div className="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                <div className="card-body p-0 d-flex">
                    ...
                    <h4 className="fw-700 text-white font-xssss mt-1"> {user} <span className="d-block font-xssss fw-500 mt-1 lh-3 text-white"> {time}</span></h4>
                    <div className="ms-auto pointer"><i className="ti-more-alt text-grey-900d btn-round-md bg-greylight font-xss"></i></div>
                </div>
                {postvideo ?  
                ...
                <div className="card-body p-0 me-lg-5">
                    <p className="fw-500 text-white lh-26 font-xssss w-100 mb-2">{des} <a href="/defaultvideo" className="fw-600 text-primary ms-2">Ver más</a></p>
                </div>
                {postimage ?
                ...
                <div className="card-body d-flex p-0">
                    <div className="emoji-bttn pointer d-flex align-items-center fw-600 text-white lh-26 font-xssss me-2" onClick={this.toggleActive}><i className="feather-thumbs-up text-white bg-primary-gradiant me-1 btn-round-xs font-xss"></i> <i className="feather-heart text-white bg-red-gradiant me-2 btn-round-xs font-xss"></i>2.8K Me gusta</div>
                    ...
                    <a href="/defaultvideo" className="d-flex align-items-center fw-600 text-white lh-26 font-xssss"><i className="feather-message-circle text-dark text-white btn-round-sm font-lg"></i><span className="d-none-xss">22 Comentarios</span></a>
                    <div className={`pointer ms-auto d-flex align-items-center fw-600 text-white lh-26 font-xssss ${menuClass}`} id={`dropdownMenu${id}`} data-bs-toggle="dropdown" aria-expanded="false" onClick={this.toggleOpen}><i className="feather-share-2 text-white btn-round-sm font-lg"></i><span className="d-none-xs">Compartir </span></div>
                    <div className={`dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg right-0 ${menuClass}`} aria-labelledby={`dropdownMenu${id}`}>
                        <h4 className="fw-700 font-xss text-grey-900 d-flex align-items-center">Compartir <i className="feather-x ms-auto font-xssss btn-round-xs bg-greylight text-grey-900 me-2"></i></h4>
                        <div className="card-body p-0 d-flex">
